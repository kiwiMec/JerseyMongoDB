 ...
 *
 * This class: - Sets the root path for the service to '/'. - Registers the
 * 'Service' class as the JAX-RS service. Note that the name of the resource is
 * given by the archive 'context.xml' content.
 *
...
public class JerseyJaxRs extends ResourceConfig {
    ...
    public JerseyJaxRs() throws UnknownHostException {
        register(nz.co.acme.spike.rest.service.Service.class);
        logger.log(Level.INFO, "Registered service {0} with Jersey.",
                nz.co.acme.spike.rest.service.Service.class.getName());
    }
